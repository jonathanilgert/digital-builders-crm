...
const NAV = [
  ...
  { id: 'agents',    label: 'Agents',         short: 'Agents',   icon: 'M12 2a4 4 0 0 1 4 4v2a4 4 0 0 1-8 0V6a4 4 0 0 1 4-4zM4 22a8 8 0 0 1 16 0' },
      ...
      <div style={{ display: 'flex', height: '100dvh', overflow: 'hidden', background: T.bg, width: '100%' }}>
        ...
        <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          ...
          <main style={{ flex: 1, minHeight: 0, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
            {page === 'tasks'     && <Tasks onOpenAgents={() => setPage('agents')} />}
